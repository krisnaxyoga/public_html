<?php
/* Template Name: one-stop-wa-shoping */
?>
    ...
    <div class="container">
        <div class="row no-gutters align-items-center">
            <div class="col-lg-6 text-center text-lg-left">
                <h1>One Stop Whats App Shopping</h1>
            ...
            <div class="col-lg-6">
                <div class="img-container text-center text-lg-right">
                    <img src="<?php echo $soms_redux['xxzzq12']['url'] ?>" alt="Home banner image" class="img-fluid">
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 text-center text-lg-left">
                    <div class="img-container">
                        <img src="<?php echo $soms_redux['xcdss']['url']; ?>" alt="Responsive Web Design"
                            class="img-fluid">
    ...
    <div class="container">
        ...
        <div class="features-grid">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="features-content">
                        <h2 class="section-title"><?php echo $soms_redux['hj0a00y']; ?></h2>
                        <?php echo $soms_redux['hj0ay']; ?>
                ...
                <div class="col-lg-5 text-center text-lg-left offset-lg-1">
                    <div class="img-container">
                        <img src="<?php echo $soms_redux['xcds9s']['url']; ?>" alt="Responsive Web Design"
                            class="img-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="features-content text-center">
                        <h2 class="section-title"><?php echo $soms_redux['hj0ay9']; ?></h2>
                        <img src="<?php echo $soms_redux['xcds96s']['url']; ?>" class="w-50" alt="">
                    </div>
                    <!-- End of .features-content -->
                </div>
            </div>
